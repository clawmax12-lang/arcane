...
.PHONY: setup format lint typecheck test test-cov check inc1 inc2 leak-lint clean clean-cache
...
# STEP-8 structural look-ahead guard: AST ban-list over the data layer (fails loud, exit 1).
